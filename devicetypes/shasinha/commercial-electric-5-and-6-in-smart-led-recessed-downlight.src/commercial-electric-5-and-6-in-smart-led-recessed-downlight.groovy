...
01 0104 0102 00 07 0000 0003 0004 0005 0006 0008 0300 01 0019
...
metadata {
    definition (name: "Commercial Electric 5 and 6 in. Smart LED Recessed Downlight", namespace: "shasinha", author: "shashvat") {
        ...
        fingerprint deviceId:"0104", inClusters:"0000, 0003, 0004, 0005, 0006, 0008, 0300", outClusters: "0019", manufacturer: "Commercial Electric", model: "53166161"
    }
    ...
    tiles {
        standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true) {
            state "on", label: '${name}', action: "switch.off", icon: "st.Lighting.light21", backgroundColor: "#79b821"
            state "off", label: '${name}', action: "switch.on", icon: "st.Lighting.light21", backgroundColor: "#ffffff"
        }
...
private getGenericName(value){
    def genericName = "Daylight"
    if(value < 3000){
        genericName = "Warm White"
    } else if(value < 3500){
        genericName = "Soft White"
    } else if(value < 4150){
        genericName = "Natural White"
    } else if(value < 5000){
